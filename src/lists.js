        ...
        if (listName == 'deviceList') {
          ...
          if (devices) {
            ...
            fileChecked++;
              ...
              //listName = [];
	      console.log('deviceList is empty');
          }
          ...
          try {
            var devices1 = JSON.parse(data).relationList;
          ...
          if (devices1) {
            console.log('--- file exists: ' + FILE_NAME);
            // copy array
            for (var i1 in devices1) {
              relationList.push(devices1[i1]);
            }
            fileChecked++;
          } else {
              //listName = [];
	      console.log("--- relationList is empty");
          }
          // wrong list
        } else {
            console.log('wrong list name');
	    throw new Error('--- wrong checkFile name:'+ listName);
        }
